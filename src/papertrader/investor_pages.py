...
ACTION_STATUS_LABELS = {
    ...
    "awaiting_final_review": "Awaiting Astra final review — not copy-ready",
    "final_review_rejected": "Astra rejected this purchase intent",
    "final_review_deferred": "Astra deferred this purchase intent",
    "approved_order_pending": "Astra-approved paper order pending fill",
