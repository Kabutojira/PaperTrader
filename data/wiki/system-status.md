...
- Error **Hermes operation validation failed: Strategy research for strategy for UBER on 2026-09-03** — post-run integrity: signal identity is invalid: unaccepted signal; visualization\_review charts do not match chart ids in changed research pages: expected \[('data/wiki/strategies/strategy for UBER.md', 'uber-baseline-scenario-returns')\], got \[('data/wiki/strategies/strategy for UBER.md', 'uber-scenario-returns')\]
