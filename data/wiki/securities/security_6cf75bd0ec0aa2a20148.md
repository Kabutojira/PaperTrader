---
title: Twist Bioscience Corporation common stock
type: security
status: maintained
...
```echart
{
  ...
  "window_days": 365,
  "data_path": "data/market/technical/security_6cf75bd0ec0aa2a20148.csv",
  "sources": [
    {
...
- Immutable security: `security_6cf75bd0ec0aa2a20148`
- Issuer: `issuer_cae5ee22a91decef8a5a`
- Instrument: common stock, Nasdaq Global Select Market (`XNAS`), USD
- Provider identity: `TWST` / `XNAS` / `USD` / equity
...
The investable thesis is that higher-throughput DNA synthesis, a broader gene and oligo portfolio,
and NGS workflow products can compound revenue while factory utilization and product mix expand
gross margin toward durable profitability. The contrary case is that rapid growth remains costly:
GAAP operating losses, high stock compensation, capital requirements, competition, supplier and
technology risks, and a premium valuation may prevent operating progress from accruing to each
existing share.

Fiscal third-quarter 2026 revenue rose 23% year over year to USD 118.4 million. DNA Synthesis and
Protein Solutions grew 39% to USD 56.6 million, while NGS Applications grew 12% to USD 61.8 million.
Gross margin reached 52.8%, up 120 basis points sequentially, and management raised fiscal 2026
revenue guidance to USD 456-457 million while reiterating a fourth-quarter adjusted-EBITDA
breakeven target. These are meaningful signs of scale, but Q3 still produced a USD 36.3 million GAAP
operating loss and USD 35.1 million net loss; adjusted EBITDA was negative USD 11.3 million.

## Evidence and decision gates

| Evidence | Interpretation |
| --- | --- |
| Cash, cash equivalents, and short-term investments totaled about USD 166.8 million at 30 June; total current assets were USD 321.3 million versus USD 120.3 million of current liabilities. | Liquidity covers the current operating runway, although it is not a substitute for proving positive cash economics. |
| Nine-month operating cash use was USD 41.3 million and property-and-equipment purchases were USD 27.6 million. | Burn is bounded relative to liquidity but remains material while the business scales. |
| Nine-month stock compensation was USD 50.4 million; 62,707,424 shares were outstanding on 29 July versus 59.6 million basic weighted-average shares in the prior-year nine-month period. | Dilution is economically material and must remain in the valuation denominator. |
| Q3 shipments reached about 2,650 customers and 369,000 genes, versus about 2,480 customers and 237,000 genes a year earlier. | Customer and physical-volume growth corroborate revenue growth, but do not yet prove durable free-cash-flow margins. |
...
Risks are failure to convert adjusted EBITDA into GAAP and cash profitability, stock compensation,
multiple compression, competition and technological substitution, customer-budget cyclicality,
supplier dependence, manufacturing execution, regulation and trade policy, intellectual-property
protection, and financing needs if burn reaccelerates.

Invalidate the thesis if Q4 breakeven slips without a credible temporary cause, revenue growth or
gross margin materially undershoots guidance, operating cash use accelerates as growth moderates,
dilution offsets operating progress, customer adoption stalls, or the platform loses cost, quality,
or turnaround-time competitiveness.
