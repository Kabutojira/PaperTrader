...
allocation_intent_id: allocation_intent_13eb8f910db9c58bece6
status: ready
---
...
The current accepted assessment uses a twelve-month EUR 30, EUR 52 and EUR 70 bear/base/bull range with probabilities of thirty, fifty and twenty percent. At the allocation plan's canonical EUR 36.88 mark, stored scenario returns are -18.66%, 41.00% and 89.80%. The stored probability-weighted return is 32.86%, confidence-adjusted expected return is 24.65%, margin of safety is 29.08%, base-upside-to-bear-downside is 2.20, and expected-upside-to-bear-downside is 1.32. These clear the current baseline frontier, so a bounded allocation is preferable to cash while the accepted relationship and evidence remain current.

The refreshed PRX mark is EUR 36.88, retrieved at 2026-09-03T21:34:54Z. It was inside the configured thirty-six-hour freshness window at evaluation. No FX conversion is required because both the security and portfolio base currency are EUR. Price freshness authorizes review only; it does not override the persisted target.
...
- Entry: permit only a time-bounded `open` signal while the current plan, unchanged intent, assessment and relationship identities remain current, the fresh EUR price is available, and deterministic code derives a positive whole-share delta toward three shares.
- Sizing: the risk budget is the baseline ceiling of five percent, not the current 1.11% target weight and not an agent-selected order size. The allocation plan remains the sole sizing authority.
...
```echart
{"schema_version":1,"chart_id":"prosus-baseline-scenario-returns","kind":"series","title":"Prosus baseline scenario returns","description":"Twelve-month bear, base and bull returns at the current allocation plan's canonical EUR 36.88 mark. The bounded baseline decision retains holding-company and look-through NAV downside and does not imply conviction sizing.","as_of":"2026-09-03T21:08:37Z","sources":[{"label":"Current allocation target and accepted Prosus assessment","observed_at":"2026-09-03T21:08:37Z"},{"label":"Prosus net asset value at 27 August 2026","url":"https://www.prosus.com/investors/investing-in-prosus/net-asset-value?locale=en","observed_at":"2026-08-28T19:18:00Z"}],"notes":["Scenario probabilities are bear 30%, base 50%, and bull 20%.","Returns are canonical stored current-plan outputs; the chart does not select quantity or authorize execution."],"x_axis":{"type":"category","label":"Scenario","values":["Bear","Base","Bull"]},"y_axes":[{"label":"Twelve-month return","unit":"percent","format":"percent"}],"series":[{"name":"Scenario return","render":"bar","y_axis":0,"values":["-18.65509996978652197608666349","40.9978267190366952414497833","89.8047667371647820557977852"]}]}
```
