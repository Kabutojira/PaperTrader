...
allocation_intent_id: allocation_intent_b658846a33beb7586a8e
status: active
---
...
Retain one long-equity leg in [[securities/security_8b703a8adf5f864acaa4|PRX]] and permit a bounded increase under the current baseline allocation. The active strategy is bound only to allocation plan `allocation_plan_4e0ef8323f8d383f6b85`, unchanged intent `allocation_intent_b658846a33beb7586a8e`, assessment `assessment_7f28dfd9240d6099400b`, and the accepted [[relationships/relationship_e514a92bf6c38d0754ee|digital-attention relationship]]. The allocator persists a twelve-share target versus eight filled shares and no pending weight; deterministic order code, not this research, derives whether a positive executable delta remains.

The structure remains baseline rather than conviction. Prosus offers Tencent-dominated look-through value, growing ecommerce exposure and per-share accretion from repurchases below NAV, but medium confidence, holding-company concentration, private-asset valuation uncertainty, central debt, governance and capital-allocation transmission prevent conviction treatment. A five percent maximum-position ceiling bounds the baseline exposure; the current 2.86% weight and 4.24% target are allocator-owned and must not be mistaken for that ceiling or for an order.
...
The current accepted assessment uses a twelve-month EUR 30, EUR 52 and EUR 70 bear/base/bull range with probabilities of thirty, fifty and twenty percent. At the current plan's canonical EUR 35.294998 mark, stored scenario returns are -15.00%, 47.33% and 98.33%. The stored probability-weighted return is 38.83%, confidence-adjusted expected return is 29.12%, margin of safety is 32.13%, base-upside-to-bear-downside is 3.15, and expected-upside-to-bear-downside is 1.94. These clear the current full-baseline frontier, so the bounded increase is preferable to cash while the accepted relationship and evidence remain current.

The refreshed PRX mark is EUR 35.294998, retrieved at 2026-09-10T18:10:21Z. It was inside the configured thirty-six-hour freshness window at evaluation. No FX conversion is required because both the security and portfolio base currency are EUR. The 10 September technical projection showed RSI 32.57, price below its twenty-, fifty- and two-hundred-day moving averages, a negative MACD histogram and an active lower-Bollinger-band trigger. This weak momentum increases timing risk even as the lower mark improves stored valuation returns; it does not override the deterministic frontier or justify enlarging the allocation target.
...
- Entry: permit only a time-bounded `open` signal while the current plan, intent, assessment and relationship identities remain current, the fresh EUR price is available, and deterministic code derives a positive whole-share delta toward twelve shares after accounting for holdings and pending orders.
- Sizing: the risk budget is the baseline ceiling of five percent, not the current 4.24% target weight and not an agent-selected order size. The allocation plan remains the sole sizing authority.
...
```echart
{"schema_version":1,"chart_id":"prosus-baseline-scenario-returns","kind":"series","title":"Prosus baseline scenario returns","description":"Twelve-month bear, base and bull returns at the current allocation plan's canonical EUR 35.29499816894531 mark. The bounded baseline increase retains holding-company and look-through NAV downside and does not imply conviction sizing.","as_of":"2026-09-10T18:10:21Z","sources":[{"label":"Current allocation target and accepted Prosus assessment","observed_at":"2026-09-10T18:10:21Z"},{"label":"Prosus net asset value at 27 August 2026","url":"https://www.prosus.com/investors/investing-in-prosus/net-asset-value?locale=en","observed_at":"2026-08-28T19:18:00Z"}],"notes":["Scenario probabilities are bear 30%, base 50%, and bull 20%.","Returns are canonical stored current-plan outputs; the chart does not select quantity or authorize execution."],"x_axis":{"type":"category","label":"Scenario","values":["Bear","Base","Bull"]},"y_axes":[{"label":"Twelve-month return","unit":"percent","format":"percent"}],"series":[{"name":"Scenario return","render":"bar","y_axis":0,"values":["-15.00212053730653548039245669","47.3296577353353385006530751","98.328385412951417212417601"]}]}
```
