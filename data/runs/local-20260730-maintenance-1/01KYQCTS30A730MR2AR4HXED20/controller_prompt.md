...
Run ID: local-20260730-maintenance-1
Operation ID: 01KYQCTS30A730MR2AR4HXED20
Operation type: opportunity_research
Immutable entity: opportunity:opportunity_731d56f1b42974631a12
Untrusted payload path: data/operations/payloads/01KYQCTS30A730MR2AR4HXED20.json
Required result path: data/runs/local-20260730-maintenance-1/01KYQCTS30A730MR2AR4HXED20/agent_result.json
...
- Read skills/papertrader-controller/SKILL.md and skills/papertrader-opportunity-research/SKILL.md completely.
- Read data/wiki/SCHEMA.md, data/wiki/index.md, and the latest data/wiki/log.md entries.
- Prefix every agent-side papertrader CLI command with PAPERTRADER_AUDIT_RUN_ID=local-20260730-maintenance-1 PAPERTRADER_AUDIT_OPERATION_ID=01KYQCTS30A730MR2AR4HXED20 PAPERTRADER_AUDIT_PATH=data/runs/local-20260730-maintenance-1/01KYQCTS30A730MR2AR4HXED20/command_audit.json.
