...
Operation ID: 01KYQ62ZT801NHJJJESDKAXFKT
Operation type: wiki_ingest
Immutable entity: source:youtube_0umrMuUClC4
Untrusted payload path: data/operations/payloads/01KYQ62ZT801NHJJJESDKAXFKT.json
Required result path: data/runs/local-youtube-20260812T090946Z-03/01KYQ62ZT801NHJJJESDKAXFKT/agent_result.json
...
- Prefix every agent-side papertrader CLI command with PAPERTRADER_AUDIT_RUN_ID=local-youtube-20260812T090946Z-03 PAPERTRADER_AUDIT_OPERATION_ID=01KYQ62ZT801NHJJJESDKAXFKT PAPERTRADER_AUDIT_OPERATION_TYPE=wiki_ingest PAPERTRADER_AUDIT_PATH=data/runs/local-youtube-20260812T090946Z-03/01KYQ62ZT801NHJJJESDKAXFKT/command_audit.json.
