...
Run ID: local-youtube-20260812T090946Z-03
Operation ID: 01KYQ62ZT86MGSMHX08KN8170X
Operation type: wiki_ingest
Immutable entity: source:youtube_UIoV8rG_25s
Untrusted payload path: data/operations/payloads/01KYQ62ZT86MGSMHX08KN8170X.json
Required result path: data/runs/local-youtube-20260812T090946Z-03/01KYQ62ZT86MGSMHX08KN8170X/agent_result.json
...
- Prefix every agent-side papertrader CLI command with PAPERTRADER_AUDIT_RUN_ID=local-youtube-20260812T090946Z-03 PAPERTRADER_AUDIT_OPERATION_ID=01KYQ62ZT86MGSMHX08KN8170X PAPERTRADER_AUDIT_OPERATION_TYPE=wiki_ingest PAPERTRADER_AUDIT_PATH=data/runs/local-youtube-20260812T090946Z-03/01KYQ62ZT86MGSMHX08KN8170X/command_audit.json.
