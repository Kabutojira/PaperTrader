...
Operation ID: 01KYQ62ZT814BHMMGYPYBHZDFG
Operation type: wiki_ingest
Immutable entity: source:youtube_Y7p4rUCdqi0
Untrusted payload path: data/operations/payloads/01KYQ62ZT814BHMMGYPYBHZDFG.json
Required result path: data/runs/local-youtube-20260812T090946Z-03/01KYQ62ZT814BHMMGYPYBHZDFG/agent_result.json
...
- Prefix every agent-side papertrader CLI command with PAPERTRADER_AUDIT_RUN_ID=local-youtube-20260812T090946Z-03 PAPERTRADER_AUDIT_OPERATION_ID=01KYQ62ZT814BHMMGYPYBHZDFG PAPERTRADER_AUDIT_OPERATION_TYPE=wiki_ingest PAPERTRADER_AUDIT_PATH=data/runs/local-youtube-20260812T090946Z-03/01KYQ62ZT814BHMMGYPYBHZDFG/command_audit.json.
