...
Operation ID: 01KYQ62ZT86XNVRAADRGMGPBZW
Operation type: wiki_ingest
Immutable entity: source:youtube_TjrShuj_Zsg
Untrusted payload path: data/operations/payloads/01KYQ62ZT86XNVRAADRGMGPBZW.json
Required result path: data/runs/local-youtube-20260812T090946Z-03/01KYQ62ZT86XNVRAADRGMGPBZW/agent_result.json
...
- Prefix every agent-side papertrader CLI command with PAPERTRADER_AUDIT_RUN_ID=local-youtube-20260812T090946Z-03 PAPERTRADER_AUDIT_OPERATION_ID=01KYQ62ZT86XNVRAADRGMGPBZW PAPERTRADER_AUDIT_OPERATION_TYPE=wiki_ingest PAPERTRADER_AUDIT_PATH=data/runs/local-youtube-20260812T090946Z-03/01KYQ62ZT86XNVRAADRGMGPBZW/command_audit.json.
