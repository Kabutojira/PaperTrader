...
Operation ID: 01KYQ49D1GRCPWM612C0NAM0Z1
Operation type: wiki_ingest
Immutable entity: source:youtube_SuSYegb8iK0
Untrusted payload path: data/operations/payloads/01KYQ49D1GRCPWM612C0NAM0Z1.json
Required result path: data/runs/local-youtube-20260812T090946Z-03/01KYQ49D1GRCPWM612C0NAM0Z1/agent_result.json
...
- Prefix every agent-side papertrader CLI command with PAPERTRADER_AUDIT_RUN_ID=local-youtube-20260812T090946Z-03 PAPERTRADER_AUDIT_OPERATION_ID=01KYQ49D1GRCPWM612C0NAM0Z1 PAPERTRADER_AUDIT_OPERATION_TYPE=wiki_ingest PAPERTRADER_AUDIT_PATH=data/runs/local-youtube-20260812T090946Z-03/01KYQ49D1GRCPWM612C0NAM0Z1/command_audit.json.
