...
Operation ID: 01KYQ62ZT8NF7ZNPSTJ69HS7V6
Operation type: wiki_ingest
Immutable entity: source:youtube_0y28p0jqPro
Untrusted payload path: data/operations/payloads/01KYQ62ZT8NF7ZNPSTJ69HS7V6.json
Required result path: data/runs/local-youtube-20260812T090946Z-04/01KYQ62ZT8NF7ZNPSTJ69HS7V6/agent_result.json
...
- Prefix every agent-side papertrader CLI command with PAPERTRADER_AUDIT_RUN_ID=local-youtube-20260812T090946Z-04 PAPERTRADER_AUDIT_OPERATION_ID=01KYQ62ZT8NF7ZNPSTJ69HS7V6 PAPERTRADER_AUDIT_OPERATION_TYPE=wiki_ingest PAPERTRADER_AUDIT_PATH=data/runs/local-youtube-20260812T090946Z-04/01KYQ62ZT8NF7ZNPSTJ69HS7V6/command_audit.json.
