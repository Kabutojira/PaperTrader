...
Operation ID: 01KYQ62ZT8HQ2V9A2XEJYRD8BY
Operation type: wiki_ingest
Immutable entity: source:youtube_gH4FTjDm9FQ
Untrusted payload path: data/operations/payloads/01KYQ62ZT8HQ2V9A2XEJYRD8BY.json
Required result path: data/runs/local-youtube-20260812T090946Z-04/01KYQ62ZT8HQ2V9A2XEJYRD8BY/agent_result.json
...
- Prefix every agent-side papertrader CLI command with PAPERTRADER_AUDIT_RUN_ID=local-youtube-20260812T090946Z-04 PAPERTRADER_AUDIT_OPERATION_ID=01KYQ62ZT8HQ2V9A2XEJYRD8BY PAPERTRADER_AUDIT_OPERATION_TYPE=wiki_ingest PAPERTRADER_AUDIT_PATH=data/runs/local-youtube-20260812T090946Z-04/01KYQ62ZT8HQ2V9A2XEJYRD8BY/command_audit.json.
