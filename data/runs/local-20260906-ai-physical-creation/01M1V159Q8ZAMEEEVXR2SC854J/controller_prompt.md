...
Run ID: local-20260906-ai-physical-creation
Operation ID: 01M1V159Q8ZAMEEEVXR2SC854J
Operation type: idea_research
Immutable entity: idea:idea_ai_driven_democratization_physical_creation
Untrusted payload path: data/operations/payloads/01M1V159Q8ZAMEEEVXR2SC854J.json
Required result path: data/runs/local-20260906-ai-physical-creation/01M1V159Q8ZAMEEEVXR2SC854J/agent_result.json
...
- Prefix every agent-side papertrader CLI command with PAPERTRADER_AUDIT_RUN_ID=local-20260906-ai-physical-creation PAPERTRADER_AUDIT_OPERATION_ID=01M1V159Q8ZAMEEEVXR2SC854J PAPERTRADER_AUDIT_OPERATION_TYPE=idea_research PAPERTRADER_AUDIT_PATH=data/runs/local-20260906-ai-physical-creation/01M1V159Q8ZAMEEEVXR2SC854J/command_audit.json.
