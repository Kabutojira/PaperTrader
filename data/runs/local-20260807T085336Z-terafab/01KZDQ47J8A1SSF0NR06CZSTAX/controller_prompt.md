...
Operation ID: 01KZDQ47J8A1SSF0NR06CZSTAX
Operation type: relationship_research
Immutable entity: relationship:relationship_terafab_tsm
Untrusted payload path: data/operations/payloads/01KZDQ47J8A1SSF0NR06CZSTAX.json
Required result path: data/runs/local-20260807T085336Z-terafab/01KZDQ47J8A1SSF0NR06CZSTAX/agent_result.json
...
- Prefix every agent-side papertrader CLI command with PAPERTRADER_AUDIT_RUN_ID=local-20260807T085336Z-terafab PAPERTRADER_AUDIT_OPERATION_ID=01KZDQ47J8A1SSF0NR06CZSTAX PAPERTRADER_AUDIT_OPERATION_TYPE=relationship_research PAPERTRADER_AUDIT_PATH=data/runs/local-20260807T085336Z-terafab/01KZDQ47J8A1SSF0NR06CZSTAX/command_audit.json.
