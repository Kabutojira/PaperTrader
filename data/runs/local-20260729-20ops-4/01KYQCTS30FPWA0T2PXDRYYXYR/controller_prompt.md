...
Operation ID: 01KYQCTS30FPWA0T2PXDRYYXYR
Operation type: security_research
Immutable entity: security:security_97f38b2cb2d5ef127f5a
Untrusted payload path: data/operations/payloads/01KYQCTS30FPWA0T2PXDRYYXYR.json
Required result path: data/runs/local-20260729-20ops-4/01KYQCTS30FPWA0T2PXDRYYXYR/agent_result.json
...
- Prefix every agent-side papertrader CLI command with PAPERTRADER_AUDIT_RUN_ID=local-20260729-20ops-4 PAPERTRADER_AUDIT_OPERATION_ID=01KYQCTS30FPWA0T2PXDRYYXYR PAPERTRADER_AUDIT_PATH=data/runs/local-20260729-20ops-4/01KYQCTS30FPWA0T2PXDRYYXYR/command_audit.json.
