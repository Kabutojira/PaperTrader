...
Operation ID: 01KYPFC140X5NVAEQ8276H0MRZ
Operation type: idea_research
Immutable entity: idea:idea_ai_infrastructure_power
Untrusted payload path: data/operations/payloads/01KYPFC140X5NVAEQ8276H0MRZ.json
Required result path: data/runs/local-20260729-20ops-4/01KYPFC140X5NVAEQ8276H0MRZ/agent_result.json
...
- Prefix every agent-side papertrader CLI command with PAPERTRADER_AUDIT_RUN_ID=local-20260729-20ops-4 PAPERTRADER_AUDIT_OPERATION_ID=01KYPFC140X5NVAEQ8276H0MRZ PAPERTRADER_AUDIT_PATH=data/runs/local-20260729-20ops-4/01KYPFC140X5NVAEQ8276H0MRZ/command_audit.json.
