...
Operation ID: 01KYHW57103NJ31X4TRFP7SD3D
Operation type: security_research
Immutable entity: security:security_a9eb9838940ef5ceaa0c
Untrusted payload path: data/operations/payloads/01KYHW57103NJ31X4TRFP7SD3D.json
Required result path: data/runs/local-20260727-daily-all-06/01KYHW57103NJ31X4TRFP7SD3D/agent_result.json
