...
Operation ID: 01KZ8BG7DRAH794C5G2FPNBQSQ
Operation type: wiki_ingest
Immutable entity: source:youtube_gIYNCsp0TFY
Untrusted payload path: data/operations/payloads/01KZ8BG7DRAH794C5G2FPNBQSQ.json
Required result path: data/runs/local-youtube-20260812T090946Z-01/01KZ8BG7DRAH794C5G2FPNBQSQ/agent_result.json
...
- Prefix every agent-side papertrader CLI command with PAPERTRADER_AUDIT_RUN_ID=local-youtube-20260812T090946Z-01 PAPERTRADER_AUDIT_OPERATION_ID=01KZ8BG7DRAH794C5G2FPNBQSQ PAPERTRADER_AUDIT_OPERATION_TYPE=wiki_ingest PAPERTRADER_AUDIT_PATH=data/runs/local-youtube-20260812T090946Z-01/01KZ8BG7DRAH794C5G2FPNBQSQ/command_audit.json.
