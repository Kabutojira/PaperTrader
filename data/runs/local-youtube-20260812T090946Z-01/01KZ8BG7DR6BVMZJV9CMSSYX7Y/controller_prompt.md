...
Operation ID: 01KZ8BG7DR6BVMZJV9CMSSYX7Y
Operation type: wiki_ingest
Immutable entity: source:youtube_ktY0IrrdSM8
Untrusted payload path: data/operations/payloads/01KZ8BG7DR6BVMZJV9CMSSYX7Y.json
Required result path: data/runs/local-youtube-20260812T090946Z-01/01KZ8BG7DR6BVMZJV9CMSSYX7Y/agent_result.json
...
- Prefix every agent-side papertrader CLI command with PAPERTRADER_AUDIT_RUN_ID=local-youtube-20260812T090946Z-01 PAPERTRADER_AUDIT_OPERATION_ID=01KZ8BG7DR6BVMZJV9CMSSYX7Y PAPERTRADER_AUDIT_OPERATION_TYPE=wiki_ingest PAPERTRADER_AUDIT_PATH=data/runs/local-youtube-20260812T090946Z-01/01KZ8BG7DR6BVMZJV9CMSSYX7Y/command_audit.json.
