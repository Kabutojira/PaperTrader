...
Operation ID: 01KYEW1K3GNVYW3MKEKGNM55QW
Operation type: idea_research
Immutable entity: idea:idea_anduril_product_company_disruption
Untrusted payload path: data/operations/payloads/01KYEW1K3GNVYW3MKEKGNM55QW.json
Required result path: data/runs/local-20260726-research-02/01KYEW1K3GNVYW3MKEKGNM55QW/agent_result.json
