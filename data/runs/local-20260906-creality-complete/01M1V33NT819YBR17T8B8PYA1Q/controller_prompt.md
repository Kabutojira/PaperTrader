...
Run ID: local-20260906-creality-complete
Operation ID: 01M1V33NT819YBR17T8B8PYA1Q
Operation type: security_research
Immutable entity: security:security_b19e8f0343b7da1f3c03
Untrusted payload path: data/operations/payloads/01M1V33NT819YBR17T8B8PYA1Q.json
Required result path: data/runs/local-20260906-creality-complete/01M1V33NT819YBR17T8B8PYA1Q/agent_result.json
...
- Prefix every agent-side papertrader CLI command with PAPERTRADER_AUDIT_RUN_ID=local-20260906-creality-complete PAPERTRADER_AUDIT_OPERATION_ID=01M1V33NT819YBR17T8B8PYA1Q PAPERTRADER_AUDIT_OPERATION_TYPE=security_research PAPERTRADER_AUDIT_PATH=data/runs/local-20260906-creality-complete/01M1V33NT819YBR17T8B8PYA1Q/command_audit.json.
