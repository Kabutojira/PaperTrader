...
Run ID: local-20260728-daily-all-28
Operation ID: 01KYKX54MRDBWHGFKQERB0YG2Q
Operation type: execute_strategy
Immutable entity: strategy:strategy_bd005fc3733b1475b6f9
Untrusted payload path: data/operations/payloads/01KYKX54MRDBWHGFKQERB0YG2Q.json
Required result path: data/runs/local-20260728-daily-all-28/01KYKX54MRDBWHGFKQERB0YG2Q/agent_result.json
