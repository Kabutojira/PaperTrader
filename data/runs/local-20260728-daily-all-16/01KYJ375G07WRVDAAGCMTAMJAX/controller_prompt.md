...
Operation ID: 01KYJ375G07WRVDAAGCMTAMJAX
Operation type: wiki_ingest
Immutable entity: source:source_5392f8ab153edf73d1e7
Untrusted payload path: data/operations/payloads/01KYJ375G07WRVDAAGCMTAMJAX.json
Required result path: data/runs/local-20260728-daily-all-16/01KYJ375G07WRVDAAGCMTAMJAX/agent_result.json
